...
void loop() {
  ...
  if (distance > Parachute_Deploy) { //Parachute Deployment
    // RGB BLUE
    setColor(0, 0, 255);
  ...
  } else if (distance > Heat_Shield_Separation && distance <= Parachute_Deploy) { //Heat Shield Separation
    // TRGB GREEN
    setColor(0, 255, 0);
  ...
  }  else if (distance > Radar_Lock && distance <= Heat_Shield_Separation) { //Radar Lock
    // RGB YELLOW
    setColor(255, 255, 0);
    ...
    } else if (distance > Terrain_Relative_Navigation && distance <= Radar_Lock) { //Terrain Relative Navigation
    // RGB WHITE
  ...
  } else if (distance > Backshell_Separation && distance <= Terrain_Relative_Navigation) { //Backshell Separation
    // RGB RED
    setColor(255, 0, 0);
  ...
  } else if (distance > Rover_Separation && distance < Backshell_Separation) { //Rover Separation
    //RGB AQUA
    setColor(0,255,255);
